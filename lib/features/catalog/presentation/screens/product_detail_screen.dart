        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (product.imageUrls.isNotEmpty) Container(height: 250, decoration: BoxDecoration(border: Border.all(color: Colors.grey.shade300), borderRadius: BorderRadius.circular(12)), child: ClipRRect(borderRadius: BorderRadius.circular(12), child: CachedNetworkImage(imageUrl: product.imageUrls.first, fit: BoxFit.contain))),
            ...
            child: Column(
              ...
              children: [
                if (product.imageUrls.isNotEmpty) ...[
                  CachedNetworkImage(imageUrl: product.imageUrls.first, height: 250, fit: BoxFit.contain),
